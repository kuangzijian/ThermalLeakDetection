...
for folder in folders:
    ...
    images_directory = '../dataset/test/{}/images'.format(folder)
    positive_samples_directory = '../dataset/LeakAI_v11_cleansed_diff_patch_cls_data/{}/leakage'.format(folder)
    negative_samples_directory = '../dataset/LeakAI_v11_cleansed_diff_patch_cls_data/{}/normal'.format(folder)
    ...
    for img_info in annotations['images']:
        ...
        img_path = os.path.join(images_directory, img_name).replace(".jpg", ".png")
